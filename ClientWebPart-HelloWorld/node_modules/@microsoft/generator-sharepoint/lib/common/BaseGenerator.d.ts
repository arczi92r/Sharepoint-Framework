...
export declare type DependencyGroups = 'react' | 'none' | 'knockout' | 'extension' | 'webpart' | 'applicationCustomizer' | 'fieldCustomizer' | 'commandSet';
...
export declare abstract class BaseGenerator<IOptions extends IBaseOptions, IContext> extends yeoman {
    ...
    private _getDependencies(group);
    private readonly _dependencyGroups;
    private _untokenizedCopier(directory, destination);
}
