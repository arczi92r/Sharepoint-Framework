        ...
        return this.checkSolution().then(() => {
            ...
            return this.prompt([
                ...
                },
                {
                    ...
                    default: (answers) => `${this.options.componentName || answers.componentName} description`
                    // required: true
                },
                {
                    type: 'list',
                ...
                const normalizedNames = normalizeComponentNames(this.options.componentName || answers.componentName, this.codeName);
